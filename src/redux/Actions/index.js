...
export function getAllUsers() {
  return async (dispatch) => {
    return await axios
      .get("https://happytails.adaptable.app/home/users")
      .then((json) =>
...
export function getAllPets() {
  return async (dispatch) => {
    return await axios
      .get("https://happytails.adaptable.app/home/pets")
      .then((json) =>
...
export function getUserDetail(id) {
  return async (dispatch) => {
    return await axios
      .get(`https://happytails.adaptable.app/home/users/${id}`)
      .then((json) =>
...
export function getPetDetail(id) {
  return async (dispatch) => {
    return await axios
      .get(`https://happytails.adaptable.app/home/pets/${id}`)
      .then((json) =>
  ...
  return async function (dispatch) {
    try {
      let json = await axios.get(
        "https://happytails.adaptable.app/home/users?name=" + name
      );
      return dispatch({
...
export function getPetByName(name) {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        "https://happytails.adaptable.app/home/pets?name=" + name
      );
      return dispatch({
  ...
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/home/pets/${id}`,
        payload
      );
      dispatch({
...
export function postUser(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/register`,
        payload
      );
      return dispatch({
...
export function postImage(archivo) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/home/images`,
        archivo
      );
      return dispatch({
  ...
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/users/${payload.id}`,
        payload
      );
      return dispatch({
...
export function patchPet(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/pets/${payload.id}`,
        payload
      );
      dispatch({
...
export function filterByQuery(filterParams) {
  return async function (dispatch) {
    let json = await axios.get(
      `https://happytails.adaptable.app/home/filters?age=${filterParams.age}&creation_date=${filterParams.creation_date}&vaccinated=${filterParams.vaccinated}&castrated=${filterParams.castrated}&location=${filterParams.location}&pet_type=${filterParams.pet_type}&pet_size=${filterParams.pet_size}&gender=${filterParams.gender}&is_adopted=${filterParams.is_adopted}`
    );
    return dispatch({
...
export function userLogin(payload) {
  return async function (dispatch) {
    try {
      await axios
        .post("https://happytails.adaptable.app/login", payload)
        .then((response) => {
  ...
  return async function (dispatch) {
    try {
      let json = await axios
        .post("https://happytails.adaptable.app/logingoogle", payload)
        .then((response) => {
          const token = response.data.data.token;
          const id = response.data.id.id;
          localStorage.setItem("token", token);
...
export function getUserProfile(id) {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        `https://happytails.adaptable.app/home/users/${id}`
      );
      return dispatch({
...
export function forgotPassword(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        "https://happytails.adaptable.app/forgotpassword",
        payload
      );
      return dispatch({
...
export function resetPassword(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/resetpassword/${payload.id}/${payload.auth}`,
        payload
      );
      return dispatch({
...
export function tradePet(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/adopt`,
        payload
      );
      return dispatch({
        type: actions.ADOPT,
...
export function patchInterestedUsers(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/interestedUsers`,
        payload
      );
      dispatch({
...
export function patchLikes(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/likes`,
        payload
      );
...
export function paymentMp(idDonor, amountDonation) {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        `https://happytails.adaptable.app/linkpayment/${idDonor}/${amountDonation}`
      );
      return dispatch({
...
export function paymentMerp(idBuyer, idProduct, quantity) {
  ...
  return async function (dispatch) {
    try {
      let json = await axios.get(
        `https://happytails.adaptable.app/linkpayment/market/${idBuyer}/${idProduct}/${quantity}`
      );
...
export function paymentCart(idBuyer, pro) {
  ...
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/linkpayment/${idBuyer}`,
        pro
      );
...
export function chatWithUser(losdosid) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        "https://happytails.adaptable.app/home/conversations/",
        losdosid
      );
      return dispatch({
...
export function getConversations(id) {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        "https://happytails.adaptable.app/home/conversations/" + id
      );
      return dispatch({
...
export function getMessages(iddd) {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        "https://happytails.adaptable.app/home/message/" + iddd
      );
      return dispatch({
...
export function viewing(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/viewing`,
        payload
      );
      return dispatch({
...
export function viewingLike(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/viewinglike`,
        payload
      );
      return dispatch({
...
export function likePet(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/home/likepets`,
        payload
      );
      dispatch({
...
export function reportPet(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/home/reportpet`,
        payload
      );
      dispatch({
...
export function reportUser(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/home/reportuser`,
        payload
      );
      dispatch({
...
export function handlePet(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/pet/`,
        payload
      );
      dispatch({
...
export function handleUser(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/user/`,
        payload
      );
      dispatch({
...
export function handlePetReport(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/petreport/`,
        payload
      );
      dispatch({
...
export function handleUserReport(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/userreport/`,
        payload
      );
      dispatch({
...
export function handleAdmin(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/admin/`,
        payload
      );
      dispatch({
...
export function getDeletedPets() {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        `https://happytails.adaptable.app/handle/deletedpets`
      );
      return dispatch({
...
export function getDeletedUsers() {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        `https://happytails.adaptable.app/handle/deletedusers`
      );
      return dispatch({
...
export function handleUserRestore(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/deleteduser/`,
        payload
      );
      dispatch({
...
export function handleUserReportRestore(payload) {
  return async function (dispatch) {
    try {
      let json = await axios.patch(
        `https://happytails.adaptable.app/handle/userreported/`,
        payload
      );
      dispatch({
...
export function getUserReportsSolved() {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        `https://happytails.adaptable.app/handle/userreports`
      );
      return dispatch({
...
export function createProduct(id, payload) {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://happytails.adaptable.app/home/product/${id}`,
        payload
      );
...
export function getAllProducts() {
  return async (dispatch) => {
    return await axios
      .get("https://happytails.adaptable.app/home/products")
      .then((json) =>
...
export function getProductDetail(id) {
  return async (dispatch) => {
    return await axios
      .get(`https://happytails.adaptable.app/home/products/${id}`)
      .then((json) =>
...
export function getProductByName(name) {
  return async (dispatch) => {
    try {
      let json = await axios.get(
        "https://happytails.adaptable.app/home/products?name=" + name
      );
      return dispatch({
...
export function filtrosMarket(filterParamsMarket) {
  return async function (dispatch) {
    let json = await axios.get(
      `https://happytails.adaptable.app/home/productsFilters?type=${filterParamsMarket.type}&category=${filterParamsMarket.category}&priceMin=${filterParamsMarket.priceMin}&priceMax=${filterParamsMarket.priceMax}`
    );
    return dispatch({
